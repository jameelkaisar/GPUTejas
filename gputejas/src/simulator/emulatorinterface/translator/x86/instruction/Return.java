...
public class Return implements PTXStaticInstructionHandler  {
	...
	{
		//In ptx according to the PTX 3.2 ISA manual, this instruction takes no arguments
		instructionArrayList.add(Instruction.getReturnInstruction());
