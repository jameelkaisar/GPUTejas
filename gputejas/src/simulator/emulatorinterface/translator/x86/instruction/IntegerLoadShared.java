...
public class IntegerLoadShared implements PTXStaticInstructionHandler {
	...
	{
			instructionArrayList.add(Instruction.getSharedLoadInstruction(p.insClass.registers,p.MemoryAddresses));
