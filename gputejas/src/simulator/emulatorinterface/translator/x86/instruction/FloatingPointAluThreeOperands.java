...
public class FloatingPointAluThreeOperands implements PTXStaticInstructionHandler{
	...
	{
		instructionArrayList.add(Instruction.getFloatingPointALU(p.insClass.registers));
