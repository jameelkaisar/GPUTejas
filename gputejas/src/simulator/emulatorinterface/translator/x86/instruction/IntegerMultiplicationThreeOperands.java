...
public class IntegerMultiplicationThreeOperands implements PTXStaticInstructionHandler{
	...
	{
		instructionArrayList.add(Instruction.getIntegerMultiplicationInstruction(p.insClass.registers));
