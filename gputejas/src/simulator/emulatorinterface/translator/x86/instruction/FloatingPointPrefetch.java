...
public class FloatingPointPrefetch implements PTXStaticInstructionHandler{
	...
	{
		instructionArrayList.add(Instruction.getAddressInstruction(p.insClass.registers));
