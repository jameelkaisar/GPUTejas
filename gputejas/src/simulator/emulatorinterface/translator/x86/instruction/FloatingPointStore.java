...
public class FloatingPointStore implements PTXStaticInstructionHandler{
	...
	{
		instructionArrayList.add(Instruction.getStoreInstruction(p.insClass.registers,p.MemoryAddresses));
