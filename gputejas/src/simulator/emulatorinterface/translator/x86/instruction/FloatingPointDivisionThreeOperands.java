...
public class FloatingPointDivisionThreeOperands implements PTXStaticInstructionHandler{
	...
	{
		instructionArrayList.add(Instruction.getFloatingPointDivision(p.insClass.registers));
