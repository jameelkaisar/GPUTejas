...
public class barrier{
    public
       public barrier(shader_core_ctx shader, int max_warps_per_core, int max_cta_per_core, int max_barriers_per_cta, int warp_size)
       {  
        ...
        if( max_warps_per_core > WARP_PER_CTA_MAX ) {
           System.out.println("ERROR ** increase WARP_PER_CTA_MAX in shader.h from %u to >= %u or warps per cta in gpgpusim.config\n", WARP_PER_CTA_MAX, max_warps_per_core );
           exit(1);
        }
       ...
       void allocate_barrier( int cta_id, warp_set_t warps )
       {
       ...
       typedef std::map<int, warp_set_t >  cta_to_warp_t;
       typedef std::map<int , warp_set_t >  bar_id_to_warp_t; /*set of warps reached a specific barrier id*/
       ...
       // assertions
       boolean warp_waiting_at_barrier( int warp_id ) const
       {
       ...
       {
        System.out.println( "barrier set information\n");
        System.out.printf( "  m_max_cta_per_core = %f\n",  m_max_cta_per_core );
        System.out.printf( "  m_max_warps_per_core = %f\n", m_max_warps_per_core );
        System.out.printf( " m_max_barriers_per_cta =%f\n", m_max_barriers_per_cta);
        System.out.println( "  cta_to_warps:\n");
